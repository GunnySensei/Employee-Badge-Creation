...
namespace CatWorx.BadgeMaker
{
    class Util
    {
        //add list param to method
        public static void PrintEmployees(List<Employee> employees){
            for(int i = 0; i < employees.Count; i++) {
                //template makes 1st arg to be left aligned and padded 10 characters
                //then print a tab \t
                //then next arg {1} left aligned and padded 20 characters
                //finally another tab, 3rd arg photoURL with no formatting
